...
print(sum(58, 99))# calling function
...
def name_score(name, score):
    return(f'Hey am {name} and I scored {score}  percent in science')
...
def find_highest_priced_product(products):
    ...
    return(f'Product with the highest price is a {highest_product_name} which has a price of {highest_price} ')
